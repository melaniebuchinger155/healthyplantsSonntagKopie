...
public class BeschreibungActivitiy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_beschreibung_activitiy);
    ...
    public void onButtonClick(View v) {
        Intent myIntent = new Intent(getBaseContext(), BeschreibungActivitiy.class);
